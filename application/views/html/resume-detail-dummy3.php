                        ...
                        <div class="subject-detail">
                            <div class="image">
                                <div class="bg-transfer">
                                    <img src="<?php echo base_url(); ?>assets/img/ProfilePic-3.jpg" alt="">
                                </div>
                            </div>
                            <div class="description">
                                ...
                                <section class="contacts">
                                    ...
                                    <figure><a href="#"><i class="fa fa-envelope"></i>john.doe@example.com</a></figure>
                                    <figure><i class="fa fa-globe"></i>(123) 456 789</figure>
                                    <figure><a href="#"><i class="fa fa-map-marker"></i>john.doe@example.com</a></figure>
                                </section>
                                <!--end contacts-->
