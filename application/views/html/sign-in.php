    ...
    <style>
        body {
            /* background-image: url(<?php echo base_url(); ?>assets/images/photo-wide-4.jpg); */
        }
        ...
        <div class="container login-container">
            <div class="row center_row" style="width: 60%;">
                ...
                <div class="col-md-6 col-sm-12 login-form-2">
                    <div class="social">
                        <div id="social_login1" class="form-group sign-with-email social_login"><a href="<?php echo base_url(); ?>register" class="cld-mail"><i class="fa fa-envelope"></i> Sign up with Email</a></div>
