...
<div id="page-content" class="subpage-detail">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Funding Details</li>
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element text-align-right"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Funding','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>
                            ...
                            <address>
								...
								<figure><i class="fa fa-money"></i><a href="#"><?php echo $post[0]->amount . " " . $post[0]->currency; ?></a></figure>
							</address>
...
$(document).ready(function(){
    ...
    var address = <?php echo $post[0]->amount; ?>;
