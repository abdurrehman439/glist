                        ...
                        ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="subject-list">
                                    <a href="<?php echo base_url(); ?>home/freelancer_detail/<?php echo $row['user_id'] ?>" class="image">
                                    ...
                                    <div class="description">
                                        <section class="name">
                                            <h3><a href="<?php echo base_url(); ?>home/freelancer_detail/<?php echo $row['user_id'] ?>"><?php echo $row['full_name'] ?></a></h3>
                    ...
                    <section>
                        ...
                        <div class="item" data-id="1">
                            <a href="#">
                                ...
                                <!--end description-->
                                <div class="image bg-transfer" style="background-repeat: no-repeat; background-size: contain; background-image: url(&quot;https://glokallist.com/assets/landing/images/no-add.jpg&quot;);">
                                    <img src="https://glokallist.com/assets/landing/images/no-add.jpg" alt="">
                                </div>
                                <!--end image-->
                            </a>
