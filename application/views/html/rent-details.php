        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="detail-sidebar">
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element text-align-right"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Rent','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>
                            ...
                            <address>
								...
								<figure><i class="fa fa-money"></i><a href="#"><?php echo $post[0]->price . " " . $post[0]->currency; ?><?php if($post[0]->price_duration == "per-hour") echo " / Hour"; elseif($post[0]->price_duration == "per-day") echo " / Day"; ?></a></figure>
							</address>
					...
					<section>
                        <h2>Social Links</h2>
                        <p><i class="fa fa-facebook" style="color:#1f1f1f;"></i> <?php echo $post[0]->facebook; ?></p>
                        <p><i class="fa fa-linkedin" style="color:#1f1f1f;"></i> <?php echo $post[0]->linkedin; ?></p>
                        <p><i class="fa fa-twitter" style="color:#1f1f1f;"></i> <?php echo $post[0]->twitter; ?></p>
                        <p><i class="fa fa-instagram" style="color:#1f1f1f;"></i> <?php echo $post[0]->instagram; ?></p>
                    </section>
