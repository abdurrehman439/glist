...
<div id="page-content" class="subpage-detail">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Service Offered Details</li>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-7">
                ...
                <!-- show review end  -->
                <!-- start add review  -->
                <?php $this->load->view('html/review_section_post'); ?>
                <!-- end add review  -->
            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="detail-sidebar">
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Service Offered','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>

                                <?php $profession = $this->db->where('user_id', $post[0]->user_id)->get('users')->result_array()[0]['profession']; ?>

                                <div class="element text-align-right"><a href="<?php echo base_url(); ?><?php if ($profession == 'agent') echo "home/agent_detail/";
                                                                                                        else if ($profession == 'freelancer') echo "home/freelancer_detail/";
                                                                                                        else if ($profession == 'resume') echo "home/resume_detail/";
                                                                                                        else if ($profession == 'service-provider') echo "home/service_detail/";
                                                                                                        else if ($profession == 'guest') echo "home/guest_detail/";
                                                                                                        else if ($profession == 'entrepreneur') echo "home/entrepreneur_detail/";
                                                                                                        else if ($profession == 'investor') echo "home/investor_detail/"; ?><?php echo $post[0]->user_id; ?>" class="btn btn-primary btn-rounded btn-xs">View Profile</a></div>
                    ...
                    <section>
                        ...
                        <dl>
                            <dt><?php echo date("g:i a", strtotime($post[0]->open_hour)); ?> - <?php echo date("g:i a", strtotime($post[0]->close_hour)); ?></dt>
                            <dd></dd>
                        </dl>
                    </section>
...
<script>
    $(document).ready(function() {
        ...
        geocoder.geocode({
            'address': "<?php echo $post[0]->zipcode; ?>"
