        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-7">
				...
				<section>
                    ...
                    <h2>Realty Details</h2>

					<p><b>Bed : </b><?php echo $post[0]->bed; ?></p>
					
					<p><b>Bath : </b><?php echo $post[0]->bath; ?></p>

					<p><b>Lot : </b><?php echo $post[0]->lot; ?></p>

					<p><b>Sewerage : </b><?php echo $post[0]->sewerage; ?></p>

					<p><b>Water : </b><?php echo $post[0]->water; ?></p>

					<p><b>Gas : </b><?php echo $post[0]->gas; ?></p>

					<p><b>Tax : </b><?php echo $post[0]->tax; ?></p>

					<p><b>Mls : </b><?php echo $post[0]->mls; ?></p>
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Realty','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>
