...
<head>
    <script data-ad-client="ca-pub-2013413810937611" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <meta charset="UTF-8" />
                ...
                <div class="right">
                    ...
                    <div class="primary-nav has-mega-menu">
                        ...
                        <a href="https://career.glokallist.com/" class="btn btn-primary btn-small icon shadow add-listing"><span>Apply for franchise</span></a> -->
                            ...
                            <li <?php if (isset($menu) && $menu == "home") {
                                    echo "class=\"active\"";
                            ...
                            <li <?php if (isset($menu) && $menu == "browse") {
                                    echo "class=\"active has-child\"";
                                } else {
                                    echo "class=\"has-child\"";
                                } ?>><a>Browse</a>
                            ...
                            <li <?php if (isset($menu) && $menu == "professionals-listing") {
                                    echo "class=\"active has-child\"";
                                } else {
                                    echo "class=\"has-child\"";
                                } ?>><a>Professionals Listing</a>
                            ...
                            ?>
                                ...
                                <li <?php if (isset($menu) && $menu == "user") {
                                        echo "class=\"active has-child\"";
                                    } else {
                                        echo "class=\"has-child\"";
                                    } ?>><a>User</a>
                            ...
                            <!--<li <?php if (isset($menu) && $menu == "agent-listing") {
                                        echo "class=\"active\"";
                                    } ?> ><a href="<?php echo base_url(); ?>home/agent_listing">Agent Listing</a></li>

                        <li <?php if (isset($menu) && $menu == "service-provider-listing") {
                                echo "class=\"active\"";
                            } ?> ><a href="<?php echo base_url(); ?>home/service_provider_listing">Service Provider Listing</a></li>-->

                            <?php /*endif;*/ ?>

                            <!--   <li <?php // if(isset($menu) && $menu == "how-it-works"){//echo "class=\"active\"";} 
                                        ?> ><a href="<?php // echo base_url(); 
                                                        ?>home/how_it_works">How It Works</a></li>-->



                            <!-- <li <?php if (isset($menu) && $menu == "about") {
                                            echo "class=\"active has-child\"";
                                        } else {
                                            echo "class=\"has-child\"";
                                        } ?>><a>About</a>
                            ...
                            <!-- <li <?php //if (isset($menu) && $menu == "contact") {
                                        // echo "class=\"active\"";
                                        // } 
                                        ?>><a href="<?php // echo base_url(); 
                                                    ?>home/contact">Contact</a></li> -->

                            <!-- <li <?php //if (isset($menu) && $menu == "invite-a-friend") {
                                        // echo "class=\"active\"";
                                        //  } 
                                        ?>><a href="<?php //echo base_url(); 
                                                ?>home/invite_a_friend">Invite A Friend</a></li> -->

                            <!-- <li <?php //if (isset($menu) && $menu == "partner-with-us") {
                                        // echo "class=\"active\"";
                                        //} 
                                        ?>><a href="<?php //echo base_url(); 
                                                ?>home/partner_with_us">Partner With Us</a></li> -->

                            <!-- <li <?php //if(isset($menu) && $menu == "app"){echo "class=\"active\"";} 
                                        ?> ><a href="<?php //echo base_url(); 
                                                        ?>home/app" target="_blank">App</a></li> -->
                    ...
                    <div class="secondary-nav" <?php if (!isset($user_id)) {
                                                    echo "style=\"border-right: 0px;\"";
                                                } ?>>
