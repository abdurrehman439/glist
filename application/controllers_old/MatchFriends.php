...
class MatchFriends extends CI_Controller {
    ...
    public function index()
	{
		...
		$this->load->view('html/match-friends-page',$user);
    ...
    public function insert(){
		...
		$this->form_validation->set_rules('age', 'Age', 'required|greater_than[0]|min_length[1]');
		$this->form_validation->set_rules('gender', 'Gender', 'required');
		
		$this->form_validation->set_rules('about-yourself', 'About Yourself', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('occupation', 'Occupation', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('religion', 'Religion', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('height', 'Height', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('ethnicity', 'Ethnicity', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('body-type', 'Body Type', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('education', 'Education', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('ideal-match', 'Ideal Match', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('relationship-history', 'Relationship History', 'required|min_length[3]|max_length[255]');
		$this->form_validation->set_rules('lifestyle', 'Lifestyle', 'required|min_length[3]|max_length[255]');
        ...
        else
        {
            $UploadPreferences = array(
                ...
                'file_name'=>$this->session->userdata('user_id')."_".time()."_match-friends.jpg"
            );
            ...
            $this->MatchFriendsModel->insert_match_friends($path);

            echo json_encode( array('success' => "Match Friends Listing has been Added.....!") );
        }
    }
    ...
    public function edit(){
        ...
        else
        {
            ...
            $this->MatchFriendsModel->edit_match_friends($path);

            echo json_encode( array('success' => "Match Friends Listing has been Edited.....!") );
        }
    }
    ...
    public function filters(){
        ...
        if( $this->input->post('index') == 0 ){
            if( sizeof($this->input->post('gender')) > 0 )
            {
                $query = $this->MatchFriendsModel->gender_filter($this->input->post('gender'), $age);
            }
            else if($this->input->post('age') != "")
            {
                $query = $this->MatchFriendsModel->age_filter($age);
			}
			else
            {
            ...
            if( sizeof($this->input->post('gender')) > 0 )
            {
                $query = $this->MatchFriendsModel->loadmore_gender_filter($this->input->post('gender'), $age, $this->input->post('index'));
            }
            else if($this->input->post('age') != "")
            {
                $query = $this->MatchFriendsModel->loadmore_age_filter($age, $this->input->post('index'));
			}
			else
            {
                return print_r(json_encode(array('result'=>"No results found")));
    ...
    {   
        if( $this->input->post('index') == 0 ){
            $query = $this->MatchFriendsModel->no_filter();
        }
        else{
            $query = $this->MatchFriendsModel->loadmore_no_filter($this->input->post('index'));
        }
    ...
    {  
        if( $this->input->post('index') == 0 ){
            $query = $this->MatchFriendsModel->search($this->input->post('keyword'));
        }
        else{
            $query = $this->MatchFriendsModel->loadmore_search($this->input->post('keyword'),$this->input->post('index'));
        }
    ...
    public function post_details($id){
        ...
        $query = $this->MatchFriendsModel->post_details($id);
		...
		$query = $this->UserModel->user_detail($data['post'][0]->user_id);
		...
		$this->load->view('includes/header',$header);
		$this->load->view('html/match-friends-details',$data);
		$this->load->view('includes/footer');
    }
    ...
    public function delete($id = '')
    {
        ...
        {
            $post = $this->MatchFriendsModel->post_details($id);
            $post = $post->result();
            ...
            if( sizeof( $post ) > 0 )
            {
                ...
                {
                    $this->MatchFriendsModel->delete_post($id);
                    $this->session->set_flashdata("success_message", "Requested Match Friends post deleted successfully!");
                    redirect("user/my_listing");
                }
                else
                {
