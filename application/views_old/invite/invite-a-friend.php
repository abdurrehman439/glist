            ...
            <div class="row">
	        	...
	        	<div class="span6">
	        		...
	        		<div class="inner">
						...
						<h2>Spread the word, invite a friend to join hands.</h2>
	        		...
	        		<div class="inner">
	        			...
	        			<div class="form-box">
	        				...
	        				<div class="top">
		        				...
		        				<p>Please complete the form to invite a friend.</p>
	        				...
	        				<div class="bottom"> 
								...
								<form action="<?php echo base_url() . 'home/send_invite_a_friend'; ?>" id="contact" name="contact" method="post" novalidate="novalidate">
									...
									<div class="form-row">									     
								        <input type="text" name="receiver_email" id="receiver_email" size="50" required class="text login_input" placeholder="Receiver Email Address" />
								    </div>
									<div class="form-row">									     
