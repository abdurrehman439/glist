...
<body>
	...
	<div class="bg-img1 size1 overlay1" style="background-image: url('<?php echo base_url(); ?>/assets/comingsoon/images/bg01.jpg');">
		<div class="size1 p-l-15 p-r-15 p-t-30 p-b-50">
			<div class="flex-w flex-sb-m p-l-75 p-r-60 p-b-165 respon1">
				<div class="wrappic1 m-r-30 m-t-10 m-b-10">
					<a href="<?php echo base_url(); ?>" class="brand"><img style="width: 60px;" src="<?php echo base_url(); ?>/assets/img/logo-white.png" alt=""></a>
				</div>
			...
			<div class="wsize1 m-lr-auto">
				<p class="txt-center l1-txt1 p-b-60">
					This section is <span class="l1-txt2">Coming Soon</span>, follow us for update now!
				</p>
