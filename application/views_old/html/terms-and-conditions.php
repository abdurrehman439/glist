        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9 col-sm-9">
                    <section>
                        <h2>Welcome to GLOKALLIST!</h2>
                        <p>These terms and conditions outline the rules and regulations for the use of Listing Portal's Website.</p>
                        <!-- <p>Listing Portal is located at:</p>
                        <p>
                    ...
                    <section>
                        <h2>Cookies</h2>
                        <p>We employ the use of cookies. By using Listing Portal's website you consent to the use of cookies in accordance with Listing Portal’s privacy policy.
                            <br><br>
                    ...
                    <section>
                        ...
                        <ol>
                            ...
                            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. Listing Portal does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of Listing Portal, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Listing Portal shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
                            <li>Listing Portal reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
                            ...
                            <li>You hereby grant to Listing Portal a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
                        </ol>
                    </section>
                    ...
                    <section>
                        <h2>WELCOME TO GLOKALLIST!</h2>
                        <p>These terms and conditions outline the rules and regulations for the use of GLOKALLIST's Website. GLOKALLIST referred as (“Company”) in the Terms & Condition.</p>
                        <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use company's website if you do not accept all of the terms and conditions stated on this page.</p>
                        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any or all Agreements: "Client", “You” and “Your” refers to you, the person accessing this website and accepting the Company’s terms and conditions. "The Company", “Ourselves”, “We”, “Our” and "Us", refers to our Company. “Party”, “Parties”, or “Us”, refers to both the Client and ourselves, or either the Client or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner, whether by formal meetings of a fixed duration, or any other means, for the express purpose of meeting the Client’s needs in respect of provision of the Company’s stated services/products, in accordance with and subject to, prevailing law of United States. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>
                    </section>
                    
                    <section>
                        <h2>Cookies</h2>
                        <p>We employ the use of cookies. By using company's website you consent to the use of cookies in accordance with company’s privacy policy.</p>
                        <p>Most of the modern day interactive web sites use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site to enable the functionality of this area and ease of use for those people visiting. Some of our affiliate / advertising partners may also use cookies.</p>
                    </section>
                    
                    <section>
                        <h2>License</h2>
                        <p>Unless otherwise stated, company and/or its licensors own the intellectual property rights for all material on GLOKALLIST.com. All intellectual property rights are reserved. You may view and/or print pages from http://www.GLOKALLIST.com/ for your own personal use subject to restrictions set in these terms and conditions.</p>
                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from http://www.GLOKALLIST.com/</li>
                            <li>Sell, rent or sub-license material from http://www.GLOKALLIST.com/</li>
                            <li>Reproduce, duplicate or copy material from http://www.GLOKALLIST.com/</li>
                        </ul>
                        <p>Redistribute content from GLOKALLIST (unless content is specifically made for redistribution).</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul>
                            <li>This Agreement shall begin on the date hereof.</li>
                            <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information, material and data ('Comments') in areas of the website. GLOKALLIST does not screen, edit, publish or review Comments prior to their appearance on the website and Comments do not reflect the views or opinions of GLOKALLIST, its agents or affiliates. Comments reflect the view and opinion of the person who posts such view or opinion. To the extent permitted by applicable laws GLOKALLIST shall not be responsible or liable for the Comments or for any loss cost, liability, damages or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</li>
                            <li>GLOKALLIST reserves the right to monitor all Comments and to remove any Comments which it considers in its absolute discretion to be inappropriate, offensive or otherwise in breach of these Terms and Conditions.</li>
                            ...
                            <li>You hereby grant to GLOKALLIST a non-exclusive royalty-free license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website, you must notify us by sending an e-mail as provided on the website’s contact us page. Please include your name, your organization name, contact information (such as a phone number and/or e-mail address) as well as the URL of your site, a list of any URLs from which you intend to link to our Web site, and a list of the URL(s) on our site to which you would like to link. Allow 2-3 weeks for a response. Note that the “Company” hold right to deny/decline full or partial any request unconditionally without any notice.</p>
                        ...
                        <p>No use of GLOKALLIST’s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                    </section>
                    ...
                    <section>
                        <h2>Disclaimer</h2>
                        <p>This website is all about connecting entrepreneurs. We as a company do not take any responsibility on any transaction, dealing, exchange, contracts, and monetary value. All decision(s) made by user(s) is/are sole responsibility of the user(s) and we do not guarantee any user(s). User(s) must be prudent enough and user(s) are solely responsible for their own decisions. User(s) are responsible for their own decision(s).</p>
                    </section>
