                        ...
                        <div class="subject-detail">
                            ...
                            <div class="description">
                                <section class="name">
                                    ...
                                    <p style="word-break: break-all;"><?php if( strlen($users_data[0]['description']) > 200 ) { echo substr($users_data[0]['description'], 0, 200) . "...."; } else { echo $users_data[0]['description']; }?></p>
                                </section>
                                <!--end description-->
