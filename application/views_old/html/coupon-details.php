            ...
            <div class="col-md-5 col-sm-5">
                ...
                <div class="detail-sidebar">
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element">Buy here coming soon</div>

                                <div class="element text-align-right"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Coupons','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Buy Here</a></div>
                            ...
                            <address>
                                ...
                                <figure><i class="fa fa-money"></i><a href="#"><?php echo $post[0]->original_price . " " . $post[0]->currency; ?>( Original )</a></figure>

                                <figure><i class="fa fa-money"></i><a href="#"><?php echo $post[0]->discounted_price . " " . $post[0]->currency; ?>( Discounted )</a></figure>
                            </address>
                    ...
                    <section>
                        <h2>Date for Post</h2>
                        <dl>
                            <dt><?php echo date('d F, Y' , strtotime($post[0]->start_date) ); ?> - <?php echo date('d F, Y' , strtotime($post[0]->finish_date) ); ?></dt>
                            <dd></dd>
                        </dl>
                    </section>
