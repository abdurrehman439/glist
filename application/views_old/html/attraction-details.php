                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Attractions','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>
