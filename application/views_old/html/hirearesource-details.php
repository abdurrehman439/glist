...
<div id="page-content" class="subpage-detail">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Gigs &amp; Freelancers Details</li>
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Gigs & Freelancers','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>

                                <?php $profession = $this->db->where('user_id',$post[0]->user_id)->get('users')->result_array()[0]['profession']; ?>
                                
                                <div class="element text-align-right"><a href="<?php echo base_url(); ?><?php if( $profession == 'agent') echo "home/agent_detail/"; else if( $profession == 'freelancer') echo "home/freelancer_detail/"; else if( $profession == 'resume') echo "home/resume_detail/"; else if( $profession == 'service-provider') echo "home/service_detail/"; else if( $profession == 'guest') echo "home/guest_detail/"; else if( $profession == 'entrepreneur') echo "home/entrepreneur_detail/"; else if( $profession == 'investor') echo "home/investor_detail/"; ?><?php echo $post[0]->user_id;?>" class="btn btn-primary btn-rounded btn-xs">View Profile</a></div>
                            ...
                            <address>
								...
								<figure><i class="fa fa-flag"></i><a href="#"><?php echo $post[0]->country; ?></a></figure>
								
								<figure><i class="fa fa-language"></i><a href="#"><?php echo $post[0]->second_language; ?></a></figure>

                                <figure><i class="fa fa-money"></i><a href="#"><?php echo $post[0]->hourly_rate . " " . $post[0]->currency; ?></a></figure>
                            </address>
...
<script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyAiM_FqkKLI0eup2tuWSJ_1IFneZsVw4ds&libraries=placess"></script>
