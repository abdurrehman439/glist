...
<html lang="en" >
	...
	<body>
		...
		<div class="form">
			<form action="<?php echo base_url(); ?>user/sign_in" method="post" class="inputs-underline">
				<div class="forceColor"></div>
				<div class="topbar">
					<div class="spanColor"></div>
					<input type="email" class="input" id="email" name="email" placeholder="Email Address" maxlength="50" required />
				</div>
				<div class="topbar">
					<div class="spanColor"></div>
					<input type="password" class="input" id="password" name="password" placeholder="Password" minlength="6" maxlength="50" required />
				</div>
		...
		<!-- <script  src="<?php echo base_url(); ?>assets/auth/js/index.js"></script> -->
	</body>
</html>
