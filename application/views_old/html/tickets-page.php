       ...
       <center > <img   class="adds_tab" src="<?php echo base_url(); ?>assets/images/banners.PNG"></center>
        ...
        <div class="hero-section has-background" style="height:100px;">
            <div class="form search-form horizontal">
                <div class="container">
                    <form id="search-form" action="<?php echo base_url(); ?>Tickets/search" method="post">
                        <div class="row">
        ...
        <div class="hero-section has-background" style="height:100px;">
            <div class="form search-form horizontal">
                <div class="container">
                    <form id="zipcode-form" action="<?php echo base_url(); ?>Tickets/zipcode" method="post">
                        <div class="row">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3">
                <aside class="sidebar">
                    <section>
                        <h2>Search Filter</h2>
                        <form id="filters-form" action="<?php echo base_url(); ?>Tickets/filters" method="post" class="form inputs-underline">
                            <div class="form-group">
                ...
                if(data.result == "No results found") {
                    ...
                    for(var i=0;i<data.length;i++)
                    {
                        ...
                        function callback(response, status,data,index,lastpost)
                        {
                            ...
                            {
                                load_more_index = data[0].tickets_id;
                                if(response['rows'][0]['elements'][0]['status'] != "ZERO_RESULTS" && response['rows'][0]['elements'][0]['status'] != "NOT_FOUND"){
                                    ...
                                    {   
                                        ...
                                        component +=         "<a href=\"<?php echo base_url();?>Tickets/post_details/" + data[0].tickets_id + "\">";
                                        ...
                                        component +=                "<ul>";
                                        component +=                    "<li><a onclick=\"addToFavourite(\'tickets\'," + data[0].tickets_id + ");\">Add to favorites</a></li>";
...
function nofilter()
{
    ...
    load_more_index = 0;
    load_more_url = '<?php echo base_url(); ?>Tickets/no_filter';
    load_more_formData = new Array();

    $.ajax({
        type : 'POST',
        url : '<?php echo base_url(); ?>Tickets/no_filter',
        data : { 
...
function load_more()
{
    ...
    console.log("Tickets ID set To before load more : " + load_more_index);
