    ...
    <div id="page-content">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Investors Profile</li>
            </ol>
            <div class="row">
                            ...
                            ?>
                                <div class="col-md-4 col-sm-6">
                                    <div class="subject-list">
                                        <a href="<?php echo base_url(); ?>home/investor_detail/<?php echo $row['user_id']?>" class="image">
                                        ...
                                        <div class="description">
                                            <section class="name">
                                                <h3><a href="<?php echo base_url(); ?>home/investor_detail/<?php echo $row['user_id']?>"><?php echo $row['full_name']?></a></h3>
