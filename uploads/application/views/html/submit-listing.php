...
<script type="text/javascript">
    ...
    $("#listing-type").on("change", function() {
		...
		else if( $("#listing-type option:selected").val() == "rent" )
        {
            ...
            $("#div-learnings-category").hide();$("#learnings-category").removeAttr("required");
            $("#div-restaurants-category").hide();$("#restaurants-category").removeAttr("required");
            $("#div-rent-category").show();$("#rent-category").removeAttr("required");$("#rent-category").attr( "required" , "required" );
            $("#div-business-sales-category").hide();$("#business-sales-category").removeAttr("required");
        	$("#div-short-term-hiring-category").hide();$("#short-term-hiring-category").removeAttr("required");
            $("#div-business-name").show();$("#business-name").removeAttr("required");$("#business-name").attr( "required" , "required" );
            $("#div-tags").show();$("#tags").removeAttr("required");$("#tags").attr( "required" , "required" );
			...
			$("#social-facebook").removeAttr("required");$("#social-facebook").attr( "required" , "required" );
			$("#social-twitter").removeAttr("required");$("#social-twitter").attr( "required" , "required" );
			$("#social-linkedin").removeAttr("required");$("#social-linkedin").attr( "required" , "required" );
			$("#social-instagram").removeAttr("required");$("#social-instagram").attr( "required" , "required" );

			
			$("#div-price-duration").show();$("#price-duration").removeAttr("required");$("#price-duration").attr( "required" , "required" );

			$("#div-address").show();$("#address").removeAttr("required");$("#address").attr( "required" , "required" );
		...
		else if( $("#listing-type option:selected").val() == "funding" )
        {
			...
			$("#div-amount").show();$("#amount").removeAttr("required");$("#amount").attr( "required" , "required" );
		...
		else if( $("#listing-type option:selected").val() == "business-sales" )
        {
            ...
            $("#div-restaurants-category").hide();$("#restaurants-category").removeAttr("required");
            $("#div-rent-category").hide();$("#rent-category").removeAttr("required");
            $("#div-business-sales-category").show();$("#business-sales-category").removeAttr("required");$("#business-sales-category").attr( "required" , "required" );
        	$("#div-short-term-hiring-category").hide();$("#short-term-hiring-category").removeAttr("required");
            $("#div-business-name").show();$("#business-name").removeAttr("required");$("#business-name").attr( "required" , "required" );
            $("#div-tags").show();$("#tags").removeAttr("required");$("#tags").attr( "required" , "required" );
            $("#div-openhouse-date").hide();$("#openhouse-date").removeAttr("required");
		...
		else if( $("#listing-type option:selected").val() == "short-term-hiring" )
        {
            ...
            $("#div-rent-category").hide();$("#rent-category").removeAttr("required");
            $("#div-business-sales-category").hide();$("#business-sales-category").removeAttr("required");
        	$("#div-short-term-hiring-category").show();$("#short-term-hiring-category").removeAttr("required");$("#short-term-hiring-category").attr( "required" , "required" );
            $("#div-business-name").show();$("#business-name").removeAttr("required");$("#business-name").attr( "required" , "required" );
            $("#div-tags").show();$("#tags").removeAttr("required");$("#tags").attr( "required" , "required" );
            $("#div-openhouse-date").hide();$("#openhouse-date").removeAttr("required");
            $("#div-date").hide();$("#date").removeAttr("required");
			...
			$("#div-work-details").show();$("#work-details").removeAttr("required");$("#work-details").attr( "required" , "required" );
			$("#div-expected-hours").show();$("#expected-hours").removeAttr("required");$("#expected-hours").attr( "required" , "required" );
			$("#div-pay").show();$("#pay").removeAttr("required");$("#pay").attr( "required" , "required" );
			$("#div-pay-duration").show();$("#pay-duration").removeAttr("required");$("#pay-duration").attr( "required" , "required" );
		...
		else if( $("#listing-type option:selected").val() == "match-friends" )
        {
            ...
            $("#div-currency").hide();$("#currency").removeAttr("required");$("#currency").attr("required","required");
			...
			$("#age").removeAttr("required");$("#age").attr( "required" , "required" );
			$("#gender").removeAttr("required");$("#gender").attr( "required" , "required" );
			$("#about-yourself").removeAttr("required");$("#about-yourself").attr( "required" , "required" );
			$("#occupation").removeAttr("required");$("#occupation").attr( "required" , "required" );
			$("#religion").removeAttr("required");$("#religion").attr( "required" , "required" );
			$("#height").removeAttr("required");$("#height").attr( "required" , "required" );
			$("#ethnicity").removeAttr("required");$("#ethnicity").attr( "required" , "required" );
			$("#body-type").removeAttr("required");$("#body-type").attr( "required" , "required" );
			$("#education").removeAttr("required");$("#education").attr( "required" , "required" );
			$("#ideal-match").removeAttr("required");$("#ideal-match").attr( "required" , "required" );
			$("#relationship-history").removeAttr("required");$("#relationship-history").attr( "required" , "required" );
			$("#lifestyle").removeAttr("required");$("#lifestyle").attr( "required" , "required" );
        }
