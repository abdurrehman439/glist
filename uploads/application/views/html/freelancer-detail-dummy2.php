    ...
    <div id="page-content">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="active">Freelancer Detail</li>
            </ol>
            <div class="row">
                        ...
                        <div class="subject-detail">
                            <div class="image">
                                <div class="bg-transfer">
                                    <img src="<?php echo base_url(); ?>assets/img/person-07-big.jpg" alt="">
                                </div>
                            </div>
                            <div class="description">
                                ...
                                <section class="contacts">
                                    ...
                                    <figure><a href="#"><i class="fa fa-envelope"></i>monica.smith@example.com</a></figure>
                                    <figure><i class="fa fa-globe"></i>(123) 456 789</figure>
                                    <figure><a href="#"><i class="fa fa-map-marker"></i>monica.smith@example.com</a></figure>
                                </section>
                                <!--end contacts-->
