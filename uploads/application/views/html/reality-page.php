...
<div id="page-content">
    <div class="container">
        ...
        <!--
            <div class="hero-section has-background" style="height:100px;">
                <div class="form search-form horizontal">
                    <div class="container">
                        <form id="search-form" action="<?php echo base_url(); ?>Reality/search" method="post">
                            <div class="row">
        ...
        <div class="hero-section has-background" style="height:100px;">
            <div class="form search-form horizontal">
                <div class="container">
                    <form id="zipcode-form" action="<?php echo base_url(); ?>Reality/zipcode" method="post">
                        <div class="row">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3">
                <aside class="sidebar">
                    <section>
                        <h2>Search Filter</h2>
                        <form id="filters-form" action="<?php echo base_url(); ?>Reality/filters" method="post" class="form inputs-underline">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <select class="form-control selectpicker" data-dropup-auto="false" data-size="8" id="bed" name="bed">
                            ...
                            <div class="form-group">
                                <select class="form-control selectpicker" data-dropup-auto="false" data-size="8" id="bath" name="bath">
                            ...
                            <div class="form-group">
                                ...
                                <div class="ui-slider" id="price-slider" data-value-min="0" data-value-max="10000000" data-step="10000" data-value-type="price" data-currency-placement="before">
                                    <div class="values clearfix">
                                        <input class="value-min" name="min-price" readonly>
                                        <input class="value-max" name="max-price" readonly>
                                    </div>
                            ...
                            <div id="date-filter">
                                <label>OpenHouse Date Filter</label>
                                
                            </div>

                            <!--end form-group-->
                            
                            <div class="form-group" id="add-date-filter" style="padding-top: 15px;">
...
<script>
    ...
    function add_date_filter(){
        $('#date-filter').append("<div id=\"div-date" + (date_filter) + "\" class=\"form-group\"><div class=\"col-xs-11\"><input type=\"text\" class=\"form-control date-picker\"id=\"date" + (date_filter) + "\" name=\"date[]\" min=\"<?php echo date('Y-m-d'); ?>\" required /></div><div class=\"col-xs-1 div-close-date\" onclick=\"close_date_filter("+ (date_filter) +");\">x</div></div>");
        $('#date' + date_filter++).datepicker();
    }
                ...
                if(data.result == "No results found") {
                    ...
                    for(var i=0;i<data.length;i++)
                    {
                        ...
                        function callback(response, status,data,index,lastpost)
                        {
                            ...
                            {
                                load_more_index = data[0].reality_id;
                                if(response['rows'][0]['elements'][0]['status'] != "ZERO_RESULTS" && response['rows'][0]['elements'][0]['status'] != "NOT_FOUND"){
                                    ...
                                    {   
                                        ...
                                        component +=         "<a href=\"<?php echo base_url();?>Reality/post_details/" + data[0].reality_id + "\">";
                                        ...
                                        component +=                "<ul>";
                                        component +=                    "<li><a onclick=\"addToFavourite(\'reality\'," + data[0].reality_id + ");\">Add to favorites</a></li>";
...
function nofilter()
{
    ...
    $("#date-filter .form-group").remove();

    $(".btn-disable").attr( "disabled" , "disabled" );

    load_more_index = 0;
    load_more_url = '<?php echo base_url(); ?>Reality/no_filter';
    load_more_formData = new Array();

    $.ajax({
        type : 'POST',
        url : '<?php echo base_url(); ?>Reality/no_filter',
        data : { 
...
function load_more()
{
    ...
    console.log("Reality ID set To before load more : " + load_more_index);
