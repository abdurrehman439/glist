                ...
                <div class="detail-sidebar">
                    ...
                    <section class="shadow">
                        ...
                        <div class="content">
                            ...
                            <div class="vertical-aligned-elements">
                                ...
                                <div class="element text-align-right"><a href="#" class="btn btn-primary btn-rounded btn-xs" onclick="set_send_message_data('Garage Sales','<?php echo $post[0]->contact_email; ?>','<?php echo base_url(uri_string()); ?>');" data-modal-external-file="modal_send_message.php" data-target="modal-send-message">Send Message</a></div>
                    ...
                    <section>
                        ...
                        <dl>
                            ...
                            <dd><?php echo date("g:i a", strtotime($post[0]->time_start)); ?> - <?php echo date("g:i a", strtotime($post[0]->time_finish)); ?></dd>
                        </dl>
                    </section>
