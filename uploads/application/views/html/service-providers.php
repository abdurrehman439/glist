                            ...
                            ?>
                                <div class="col-md-4 col-sm-6">
                                    <div class="subject-list">
                                        <a href="<?php echo base_url(); ?>home/service_detail/<?php echo $row['user_id']?>" class="image">
                                        ...
                                        <div class="description">
                                            <section class="name">
                                                <h3><a href="<?php echo base_url(); ?>home/service_detail/<?php echo $row['user_id']?>"><?php echo $row['full_name']?></a></h3>
